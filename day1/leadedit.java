...
public class leadedit {
	...
	public static void main(String[] args) {
       ...
       driver.findElement(By.id("createLeadForm_description")).sendKeys("hi this is me");
       ...
       driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("kindly reply as back");
       driver.findElement(By.className("smallSubmit")).click();
